  ...
  public:
    ...
    void setParams(base_d400_paramsConfig &config, const std::vector<AbstractParamDescriptionConstPtr> params)
    {
      for (std::vector<AbstractParamDescriptionConstPtr>::const_iterator _i = params.begin(); _i != params.end(); ++_i)
      {
        ...
        if("base_sensors_enabled"==(*_i)->name){base_sensors_enabled = boost::any_cast<bool>(val);}
...
//#line 290 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(base_d400_paramsConfig::AbstractParamDescriptionConstPtr(new base_d400_paramsConfig::ParamDescription<int>("base_depth_visual_preset", "int", 3, "D400 Visual Presets", "{'enum_description': 'D400 Visual Presets', 'enum': [{'srcline': 11, 'description': 'Custom', 'srcfile': '/home/tiffany/ros_catkin_ws/src/realsense/realsense2_camera/cfg/base_d400_params.py', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'Custom'}, {'srcline': 12, 'description': 'Default Preset', 'srcfile': '/home/tiffany/ros_catkin_ws/src/realsense/realsense2_camera/cfg/base_d400_params.py', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'Default'}, {'srcline': 13, 'description': 'Hand Gesture', 'srcfile': '/home/tiffany/ros_catkin_ws/src/realsense/realsense2_camera/cfg/base_d400_params.py', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'Hand'}, {'srcline': 14, 'description': 'High Accuracy', 'srcfile': '/home/tiffany/ros_catkin_ws/src/realsense/realsense2_camera/cfg/base_d400_params.py', 'cconsttype': 'const int', 'value': 3, 'ctype': 'int', 'type': 'int', 'name': 'HighAccuracy'}, {'srcline': 15, 'description': 'High Density', 'srcfile': '/home/tiffany/ros_catkin_ws/src/realsense/realsense2_camera/cfg/base_d400_params.py', 'cconsttype': 'const int', 'value': 4, 'ctype': 'int', 'type': 'int', 'name': 'HighDensity'}, {'srcline': 16, 'description': 'Medium Density', 'srcfile': '/home/tiffany/ros_catkin_ws/src/realsense/realsense2_camera/cfg/base_d400_params.py', 'cconsttype': 'const int', 'value': 5, 'ctype': 'int', 'type': 'int', 'name': 'MediumDensity'}]}", &base_d400_paramsConfig::base_depth_visual_preset)));
//#line 290 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 290 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __min__.base_sensors_enabled = 0;
//#line 290 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __max__.base_sensors_enabled = 1;
//#line 290 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __default__.base_sensors_enabled = 1;
//#line 290 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(base_d400_paramsConfig::AbstractParamDescriptionConstPtr(new base_d400_paramsConfig::ParamDescription<bool>("base_sensors_enabled", "bool", 8, "Sensors Enabled", "", &base_d400_paramsConfig::base_sensors_enabled)));
//#line 290 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(base_d400_paramsConfig::AbstractParamDescriptionConstPtr(new base_d400_paramsConfig::ParamDescription<bool>("base_sensors_enabled", "bool", 8, "Sensors Enabled", "", &base_d400_paramsConfig::base_sensors_enabled)));
//#line 290 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 290 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(base_d400_paramsConfig::AbstractParamDescriptionConstPtr(new base_d400_paramsConfig::ParamDescription<std::string>("base_JSON_file_path", "str", 9, "JSON_file_path", "", &base_d400_paramsConfig::base_JSON_file_path)));
//#line 290 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(base_d400_paramsConfig::AbstractParamDescriptionConstPtr(new base_d400_paramsConfig::ParamDescription<std::string>("base_JSON_file_path", "str", 9, "JSON_file_path", "", &base_d400_paramsConfig::base_JSON_file_path)));
