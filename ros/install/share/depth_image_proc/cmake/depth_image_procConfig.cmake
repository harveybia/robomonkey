...
if("FALSE" STREQUAL "TRUE")
  set(depth_image_proc_SOURCE_PREFIX /home/tiffany/ros_catkin_ws/src/image_pipeline/depth_image_proc)
  set(depth_image_proc_DEVEL_PREFIX /home/tiffany/ros_catkin_ws/devel)
  ...
  set(depth_image_proc_INSTALL_PREFIX /home/tiffany/ros_catkin_ws/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'depth_image_proc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tiffany/ros_catkin_ws/install/${idir}'.  ${_report}")
    endif()
